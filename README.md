...
In this project I wanted to solve the Travelling Salesperson Problem using Python. A brief introduction for the theoretical background can be found in the [TSP_review.pdf](TSP_review.pdf) file. The code is uploaded in pdf format ([TSP.pdf](TSP.pdf)) and as a jupyter notebook [TSP.ipynb](TSP.ipynb) which users can download and run.
